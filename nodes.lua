...
minerals.register_mineral('minerals:raw_coal', {
	...
	tiles = {'default_stone.png^minerals_ore_coal.png'},
	groups = {cracky = 3},
...
minerals.register_mineral('minerals:raw_copper', {
	...
	tiles = {'default_stone.png^minerals_ore_copper.png'},
	groups = {cracky = 2},
...
minerals.register_mineral('minerals:raw_diamond', {
	...
	tiles = {'default_stone.png^minerals_ore_diamond.png'},
	groups = {cracky = 1},
...
minerals.register_mineral('minerals:raw_gold', {
	...
	tiles = {'default_stone.png^minerals_ore_gold.png'},
	groups = {cracky = 2},
...
minerals.register_mineral('minerals:raw_iron', {
	...
	tiles = {'default_stone.png^minerals_ore_iron.png'},
	groups = {cracky = 2},
...
minerals.register_mineral('minerals:raw_mese', {
	...
	tiles = {'default_stone.png^minerals_ore_mese.png'},
	groups = {cracky = 1},
...
minerals.register_mineral('minerals:raw_tin', {
	description = 'Tin Ore',
	tiles = {'default_stone.png^minerals_ore_tin.png'},
	groups = {cracky = 2},
